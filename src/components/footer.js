...
import {FaqOvalfrom} from '../assets/img/index'

const Footer = () => {
  return (
    <form class="footer-C61RwL" name="none" action="none" method="post">
          <input type="text" name="trapit" value="" style={{display : 'none'}} />
          <div class="overlap-group9-iPe1yZ">
          ...
          <div class="anima-container-center-horizontal">
            <div class="fypsoundslogo-iPe1yZ"></div>
          </div>
          <div class="anima-container-center-horizontal">
            <div class="copyright--51-2021-al-iPe1yZ montserrat-normal-white-13px">
